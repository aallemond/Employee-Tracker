...
// Starts the server after DB connects
db.connect(err => {
    if (err) throw err;
...
var employee_tracker = function () {
    inquirer.prompt([{
        ...
        // Shows the Department Table in the Database if View Departments is selected
        if (answers.prompt === 'View Departments') {
            ...
            //Shows Roles table if View Roles is selected
